...
export default function MinimalistLogin({ onLoginSuccess }) {
 ...
 <h1 className="text-5xl font-bold tracking-[0.15em] text-slate-900 select-none">
 V<span>ASTARA</span>
 </h1>
 <p className="text-xs tracking-[0.3em] text-slate-400 uppercase mt-2">
 properti tepercaya
 </p>
 </div>
 ...
 className="font-medium text-slate-900 hover:text-[#FF6B00] transition-colors"
 >
 Daftar
 </button>
 </p>
 ...
 <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-100 rounded-2xl p-6 -mx-2">
 ...
 <div>
 <label htmlFor="firstName" className="text-xs font-medium text-slate-600 mb-1.5 block">
 Nama Depan
 </label>
 <input
 id="firstName"
 ...
 <div>
 <label htmlFor="whatsapp" className="text-xs font-medium text-slate-600 mb-1.5 block">
 No WhatsApp
 </label>
 <input
 id="whatsapp"
 ...
 <div>
 <label htmlFor="reg-email" className="text-xs font-medium text-slate-600 mb-1.5 block">
 Email
 </label>
 <input
 id="reg-email"
 ...
 <div>
 <label htmlFor="reg-password" className="text-xs font-medium text-slate-600 mb-1.5 block">
 Password
 </label>
 <div className="relative">
 <input
