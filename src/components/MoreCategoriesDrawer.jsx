      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[110] bg-brand-surface rounded-t-3xl max-h-[85vh] overflow-y-auto pb-8"
          >
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className="flex flex-col items-center gap-1.5 active:scale-90 transition-transform relative"
                        >
